...
4. خطوط داخل یک حباب / باکس UI را گروه‌بندی می‌کند؛ تبلیغ، واترمارک و SFX را جدا می‌کند تا ترجمه نشوند
...
| **گروه‌بندی حباب** | ادغام خطوط داخل یک حباب یا باکس UI؛ جدا نگه داشتن حباب کوچک گوشه‌ای از حباب بزرگ |
...
| **فیلتر تبلیغ / SFX** | واترمارک، لینک سایت، SFX و junk ترجمه و پاک نمی‌شوند؛ با دیالوگ قاطی نمی‌شوند |
