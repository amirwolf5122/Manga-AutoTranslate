...
3. **OCR** با PaddleOCR متن هر حباب را استخراج می‌کند (انگلیسی / کره‌ای / ژاپنی)
4. متن‌های تبلیغاتی، واترمارک و SFX را جدا می‌کند تا ترجمه نشوند
5. فحش‌های سانسور‌شده را بازسازی می‌کند، سپس با مدل انتخابی به فارسی محاوره‌ای ترجمه می‌کند
...
| **فیلتر تبلیغ / SFX** | واترمارک، لینک سایت، SFX و junk ترجمه و پاک نمی‌شوند |
---
