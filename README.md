...
| **Stitch صفحات کوتاه** | چسباندن صفحات کوتاه به نوارهای تا ۱۶۰۰۰px برای کم کردن مصرف API |
...
| `--stitch-max-height` | سقف ارتفاع نوارهای چسبانده‌شده از صفحات کوتاه؛ `0` = خاموش | `16000` |
| `--no-stitch-keep-first` | صفحهٔ اول را هم داخل نوارها بگذار (پیش‌فرض: صفحهٔ اول جدا) | — |
