...
if !NEED_INSTALL! equ 1 (
    ...
    pip install --no-cache-dir --constraint constraints.txt Pillow pyclipper lmdb scikit-image shapely python-bidi arabic-reshaper rapidfuzz imageio matplotlib tqdm requests beautifulsoup4 google-genai decorator opt-einsum astor pyyaml
